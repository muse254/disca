...
Left unaddressed, honest nodes disagree intermittently and no job settles: in measurement, one quarter of jobs failed outright and half incorrectly reported an honest node as disagreeing.
Fixing the algorithm selection in advance removes the divergence at no measurable cost.
